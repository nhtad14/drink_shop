            ...
            <div class="grid">
                <div class="grid__row app__content">
                    ...
                    <div class="grid__column-10">
                        <div class="contact">
                            <h1 class="contact__name">Đổi mật khẩu </h1>
                            <?php 
                            $password=  $_COOKIE["password"];
                            $decoded_password= base64_decode($password);
                            ?>
                            <form method="POST" action="Update_psw">
                                <div class="contact__form">
                                    <p>Hãy đổi lại mật khẩu nếu thấy bảo mật yếu !</p>
                                    <hr>
                                    <label for="phone"><b>Mật khẩu cũ</b></label>
                                    <input class="contact__input ative" type="password"
                                        value="<?php echo $decoded_password ?>" readonly>

                                    <label for="email"><b>Mật khẩu mới</b></label>
                                    <input class="contact__input" type="password" name="psw" pattern="[0-9]{4,6}"
                                        required>

                                    <div class="clearfix">
                                        <button type="submit_psw" name="submit_psw"
                                            class="contact__name-btn btn btn--primary">Cập nhật mật khẩu</button>
                                    </div>
                                </div>
                            </form>
                        </div>
