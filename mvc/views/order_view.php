            ...
            <div class="grid">
                <div class="grid__row app__content">
                    ...
                    <div class="grid__column-10">
                        <div class="contact">
                            <h1 class="contact__name">Chi tiết sản phẩm đơn hàng </h1>
                            <table>
                                <thead>
                                    <tr>
                                        <th>STT</th>
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php while($row = mysqli_fetch_array($data["Order"])) { ?>
                                    <td><?php echo $i++ ?> </td>
                                    <td><?php echo $row["name_product"]; ?> </td>
                                    <td><img src="./assets/img/products/<?php echo $row["img_product"]; ?>" alt=""
                                            class="header__cart-items-img"> </td>
